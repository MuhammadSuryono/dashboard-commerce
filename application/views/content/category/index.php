<div class="card">
    <div class="card-header">
        <h5 class="card-title"><button class="btn btn-primary btn-sm btn-flat" data-toggle="modal" data-target="#modal-category"><i class="fas fa-plus-circle"></i> Create New Category</button></h5>
    </div>
    <!-- /.card-header -->
    <div class="card-body">
