            ...
            <form action="<?=base_url() . 'product/create' ?>" method="post">
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control rounded-0" placeholder="908959xxxx" required>
                    </div>
                    <div class="form-group">
                        <label for="exampleInputRounded0">Product Name <small class="text-red"><i>*</i></small></label>
                        <input type="text" class="form-control rounded-0" placeholder="Detergen" required>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control rounded-0" placeholder="0" value="0" required>
                    </div>
                    <div class="form-group">
                        <label for="exampleInputRounded0">Stock <small class="text-red"><i>*</i></small></label>
                        <input type="text" class="form-control rounded-0" placeholder="Detergen" value="0" required>
                    </div>
                    <div class="form-group">
                        <label for="exampleInputRounded0">Unit <small class="text-red"><i>*</i></small></label>
                        <input type="text" class="form-control rounded-0" placeholder="Pax" required>
                    </div>
                    <div class="form-group">
                        <label for="exampleInputRounded0">Color</label>
                        <input type="text" class="form-control rounded-0 my-colorpicker1" placeholder="xxxx">
                    </div>
                    <div class="form-group">
                        <label for="exampleInputRounded0">Item Size</label>
                        <input type="text" class="form-control rounded-0" placeholder="Width x Height">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control rounded-0" placeholder="xxxx">
                    </div>
                </div>
