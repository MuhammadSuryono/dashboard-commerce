...
class Account extends My_Controller
{
    ...
    {
        $data = $this->http_request_get($this->BASE_URL . 'account');
        $this->parseData['title_budge'] = 'account';
        $this->parseData['title_tab'] = 'account';
        $this->parseData['content'] = 'content/account/index';
        $this->parseData['javascript'] = $this->js;
        $this->parseData['css'] = $this->css;
        $this->parseData['accounts'] = $data->data;
